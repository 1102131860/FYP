  ...
  onLoad: function (options) {
    ...
    wx.onBluetoothDeviceFound(function (devices) {
      ...
      if (devices.deviceId) {
        ...
        if (isnotexist && devices.connectable && devices.name.length > 0) {
        ...
        if (isnotexist && devices.devices[0].connectable && devices.devices[0].name.length > 0) {
        ...
        if (isnotexist && devices[0].connectable && devices[0].name.length > 0) {
